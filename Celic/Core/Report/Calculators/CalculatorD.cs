...
namespace Celic
{
    ...
    sealed class CalculatorD : BaseCalculator
    {
        ...
        public CalculatorD(SCalcDViewModel model)
        {
        ...
        public CalculatorD(ObservableCollection<Plast> leftPlasts, ObservableCollection<Plast> rightPlasts)
        {
        ...
        protected override void WriteCalculation()
        {
            ...
            float[] htRight = HtMorePlastsWithLog(_rightPlasts);
            AddParagraph("Вычислим величины высот ЗВТ для пластов, лежащих слева от разлома");
            float[] htLeft = HtMorePlastsWithLog(_leftPlasts);
