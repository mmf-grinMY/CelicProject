...
namespace Celic
{
    ...
    public abstract class ListPlastViewModel : BaseViewModel, ICalcViewModel
    {
        ...
        protected ListPlastViewModel(MainWindow mainWindow, Window window) 
        {
            ...
            {
                if (obj is ObservableCollection<Plast>)
                    new AddPlastWindow(obj as ObservableCollection<Plast>).ShowDialog();
                else
