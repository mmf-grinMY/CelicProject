...
namespace Celic
{
    class SCalcDViewModel : ListPlastViewModel
    {
        ...
        {
            LeftPlasts = new ObservableCollection<Plast>(); //{ new Plast() { H = "300" }, new Plast() { H = "570,3" }, new Plast() { H = "750" } };
            RightPlasts = new ObservableCollection<Plast>(); //{ new Plast() { H = "300" }, new Plast() { H = "570,3" }, new Plast() { H = "750" } };
