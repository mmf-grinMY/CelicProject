...
namespace Celic
{
    ...
    public abstract class ListPlastViewModel : BaseViewModel, ICalcViewModel
    {
        ...
        public Plast SelectedPlast
        {
            ...
            set
            {
                if (_calcWindow.GetType() == typeof(CalculationBWindow))
                    (_calcWindow as CalculationBWindow).selected.IsEnabled = (_selectedPlast = value) != null;
                else if (_calcWindow.GetType() == typeof(CalculationCWindow))
                    (_calcWindow as CalculationCWindow).selected.IsEnabled = (_selectedPlast = value) != null;
                else if (_calcWindow.GetType() == typeof(CalculationDWindow))
                    (_calcWindow as CalculationDWindow).selected.IsEnabled = (_selectedPlast = value) != null;
