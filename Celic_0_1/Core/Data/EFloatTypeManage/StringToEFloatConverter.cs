...
namespace Celic
{
    ...
    public class StringToEFloatConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type typeTarget, object param, CultureInfo culture) => value?.ToString();
        ...
        public object ConvertBack(object value, Type typeTarget, object param, CultureInfo culture) =>
            value != null && value.ToString() != "" ? (object)EFloat.Parse(value.ToString()) : new EFloat(-1, EFloat.Format.empty);
    }
}
